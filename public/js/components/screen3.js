...
const Screen3 = (update) => {
  ...
  const span = $('<div class="content-span center"><span class="strong-span black-text">Ahora ingresa tu código</span><p>Enviamos un SMS con el código de validación al número 999999999</p></div>');
